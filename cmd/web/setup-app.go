...
func setupApp() (*string, error) {
	...
	identifier := flag.String("identifier", "jacksspicyms", "unique identifier")
	...
	databaseName := flag.String("db", "jacksspicyms", "database name")
	...
	preferenceMap["version"] = jacksspicymsVersion
